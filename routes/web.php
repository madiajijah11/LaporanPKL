...
Route::group(['middleware' => 'auth'], function() {
    ...
    Route::group(['prefix' => 'invoice'], function() {
        Route::get('/new', 'InvoiceController@create')->name('invoice.create'); //ROUTE UNTUK HALAMAN INVOICE
        Route::post('/', 'InvoiceController@save')->name('invoice.store'); //ROUTE UNTUK MENG-HANDLE DATA
